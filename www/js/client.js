...
let recStartTime;
let recElapsedTime;
let WalkTalkTheme = "neon"; // neon - dark - forest - ghost ...
...
function getHtmlElementsById() {
  ...
  themeSelect = getId("WalkTalkTheme");
...
function welcomeUser() {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      let message = {
        email: "",
        subject: "Please join our WalkTalk Video Chat Meeting",
    ...
    event.channel.onmessage = (msg) => {
      switch (event.channel.label) {
        case "WalkTalk_chat_channel":
          ...
          break;
        case "WalkTalk_file_sharing_channel":
...
/**
 * Set WalkTalk theme neon - dark - forest - sky - ghost
 * @param {*} theme
 */
...
function selectFileToShare() {
  ...
  Swal.fire({
    allowOutsideClick: false,
    background: swalBackground,
    imageAlt: "WalkTalk-file-sharing",
  ...
  if (isImageURL(incomingFileInfo.fileName)) {
    ...
    reader.onload = (e) => {
      Swal.fire({
        ...
        imageAlt: "WalkTalk-file-img-download",
        showDenyButton: true,
    ...
    Swal.fire({
      allowOutsideClick: false,
      background: swalBackground,
      imageAlt: "WalkTalk-file-download",
      imageUrl: fileSharingImg,
      position: "center",
      title: "Received file",
      text:
...
function disableAllPeers(element) {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    imageAlt: "WalkTalk-disable-" + element,
    imageUrl: confirmImg,
    title:
      element == "audio"
        ? "Mute everyone except yourself?"
